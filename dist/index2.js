...
var ItemView = /*#__PURE__*/function (_View) {
  (0,_opt_homebrew_lib_node_modules_hummer_cli_node_modules_babel_runtime_helpers_esm_inherits_js__WEBPACK_IMPORTED_MODULE_2__["default"])(ItemView, _View);

  var _super = (0,_opt_homebrew_lib_node_modules_hummer_cli_node_modules_babel_runtime_helpers_esm_createSuper_js__WEBPACK_IMPORTED_MODULE_3__["default"])(ItemView);

  function ItemView(position) {
    var _this;

    (0,_opt_homebrew_lib_node_modules_hummer_cli_node_modules_babel_runtime_helpers_esm_classCallCheck_js__WEBPACK_IMPORTED_MODULE_1__["default"])(this, ItemView);
    ...
    var tx = new _hummer_hummer_front__WEBPACK_IMPORTED_MODULE_4__.Text();
    tx.style = {
      fontSize: 12
    };
    tx.text = '第' + position + '个';

    _this.appendChild(tx);

    return _this;
  }

  return (0,_opt_homebrew_lib_node_modules_hummer_cli_node_modules_babel_runtime_helpers_esm_createClass_js__WEBPACK_IMPORTED_MODULE_0__["default"])(ItemView);
...
var RootView = /*#__PURE__*/function (_View) {
  ...
  function RootView() {
    ...
    (0,_opt_homebrew_lib_node_modules_hummer_cli_node_modules_babel_runtime_helpers_esm_classCallCheck_js__WEBPACK_IMPORTED_MODULE_1__["default"])(this, RootView);
    ...
    _this.appendChild(head);

    var scrollView = new _hummer_hummer_front__WEBPACK_IMPORTED_MODULE_5__.Scroller();
    scrollView.style = {
      width: '100%',
      maxHeight: 300,
      flexShrink: 1
    ...
    for (var i = 0; i < 20; i++) {
      scrollView.appendChild(new _views_itemView__WEBPACK_IMPORTED_MODULE_6__.ItemView(i));
    }

    _this.appendChild(scrollView);

    var food = new _hummer_hummer_front__WEBPACK_IMPORTED_MODULE_5__.View();
    food.style = {
      width: '100%',
      height: 40,
    ...
    _this.appendChild(food);

    return _this;
  }

  return (0,_opt_homebrew_lib_node_modules_hummer_cli_node_modules_babel_runtime_helpers_esm_createClass_js__WEBPACK_IMPORTED_MODULE_0__["default"])(RootView);
...
/******/ })()
;
//# sourceMappingURL=http://172.24.216.18:8000/index2.js.map